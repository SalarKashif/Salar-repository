...
<html lang = "eng">
  ...
  <body class="body_style dark">
    ...
    <div id="wrapper">
      <main>
        <h3 class="intro-caption dark">Welcome to a Showcase of the Worlds Best Zoos!</h3>
        <p class="gallery-caption">These are a few of the notable zoos that you will see while you're here...</p>
        <div class="gallery">
          <div class="box dark"> 
            <div class="image">
